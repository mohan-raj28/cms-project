...
export default function Login() {
	...
	function handleSubmit(event) {
		...
		// After login, redirect to display page
			...
			>
				...
				>
					<div className="flex flex-col items-center mb-2">
						...
						>
							<path
								...
								strokeWidth={2}
								d="M12 17v2m0 0a2 2 0 01-2 2h-4a2 2 0 01-2-2v-2a2 2 0 012-2h4a2 2 0 012 2zm0 0v-2m0 0a2 2 0 012-2h4a2 2 0 012 2v2a2 2 0 01-2 2h-4a2 2 0 01-2-2z"
							/>
						</svg>
					...
					<div className="relative">
						...
						/>
						<span className="absolute left-4 top-3 text-emerald-300">📧</span>
					</div>
